pub const KING_BASE_HP: f32 = 600.0;
pub const KING_BASE_DAMAGE: f32 = 25.0;
pub const KING_BASE_RATE: f32 = 0.5;
pub const KING_BASE_RANGE: f32 = 200.0;
pub const KING_REGEN_PER_WAVE: f32 = 10.0;
...
mod tests {
    ...
    fn king_base_stats_are_correct() {
        assert_eq!(KING_BASE_HP, 600.0);
        assert_eq!(KING_BASE_DAMAGE, 25.0);
        assert_eq!(KING_BASE_RATE, 0.5);
        assert_eq!(KING_BASE_RANGE, 200.0);
        assert_eq!(KING_REGEN_PER_WAVE, 10.0);
    ...
    fn king_upgrade_tiers_have_correct_values() {
        ...
        assert_eq!(KING_UPGRADE_TIERS[0].income_delta, 4);
        ...
        assert_eq!(KING_UPGRADE_TIERS[1].income_delta, 6);
        ...
        assert_eq!(KING_UPGRADE_TIERS[2].income_delta, 8);
        ...
        assert_eq!(KING_UPGRADE_TIERS[3].income_delta, 10);
    }
